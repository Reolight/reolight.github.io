...
describe("Tests for mask regenerator", () => {
    it("Регенерирует кусок простой маски", () => {
    ...
    it("Регенерирует кусок маски c литералом", () => {
    ...
    it("Регенерирует маску, потому что цифровой символ попадает на цифровой", () => {
    ...
    it("Откатывает к исходному состоянию, потому что новый вариант не подходит под маску", () => {
        maskSynthetizer.generate("99L99");
        maskSynthetizer.putSymbols("19a4", 0); // 19
    ...
    it("Регенерирует маску и принимает изменнеия, потому что символы подходят, в новом месте торчит литерал", () => {
    ...
    it("Регенерирует маску и принимает изменения, в старом месте литералы", () => {
    ...
    it("Регенерирует как гидра.. ЕМУ СНЕСЛО БОШКУ, А ОНА ОТРОСЛА!!!1", () => {
        maskSynthetizer.generate("99L.L99.L.L");
        maskSynthetizer.putSymbols("19aa68dd", 0); // 19a.a68.d.d
    ...
    it("Правильно регенерирует маску со смесью обязательных и необязательных символов: удаление и смещение возможно", () => {
    ...
    it("регенерирует маску, когда удалён последний символ", () => {
